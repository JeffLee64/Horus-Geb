function stats = plotVenusHistogram_BA(nD,Dlower,Dupper,nV,Vlower,Vupper,nAngles,AtmosphereMultiplier,SurfaceAge)
...
try
    ...
    VenusCraterHistogram_BA(FLAVRS,Diameters,Velocities,Angles,...
        CraterDiameters,SurfaceAge)
catch
    parallel=1;
    stats=VenusCraterSimulation_BA(nD,Dlower,Dupper,...
