function stats = plotVenusHistogram_LW(nD,Dlower,Dupper,nV,Vlower,Vupper,nAngles,AtmosphereMultiplier,SurfaceAge)
...
try
    ...
    VenusCraterHistogram_LW(FLAVRS,Diameters,Velocities,Angles,...
        CraterDiameters,SurfaceAge)
catch
    parallel=1;
    stats=VenusCraterSimulation_LW(nD,Dlower,Dupper,...
